...
const I18N = {
  zh: {
    ...
    "sync.help": "首次使用 Turso？按下面步骤获取数据库 URL 和 Token",
    "sync.helpSignup": "注册 / 登录",
    "sync.helpSignupLink": "打开控制台",
    "sync.helpStep2Title": "创建数据库",
    "sync.helpGuide": "创建数据库指南",
    "sync.helpStep3Title": "创建 Token",
    ...
    "deploy.projectIdHint": "填 ID 锁定已有项目（不新建）；留空按名查找，找不到才创建",
    "deploy.start": "部署",
    "deploy.cancel": "取消",
    ...
    "publish.step1": "用来存储文章、媒体资源数据，Turso 免费额度满足个人博客使用",
    "publish.step1Link": "创建数据库指南",
    "publish.step2Label": "Step 2",
    "publish.step2Title": "部署到 Vercel",
    "publish.step2": "按照指南中部署到 Vercel 的步骤配置即可",
    "publish.step2Link": "打开指南",
    "publish.step3Label": "Step 3",
    "publish.step3Title": "填入同步信息",
    "publish.step3": "打开「同步设置」，粘贴数据库 URL 和 Token，点击保存即可",
    "publish.step4Label": "Step 4",
    "publish.step4Title": "配置流量分析",
    "publish.step4": "「流量分析」中按需配置 Vercel Analytics 和 Google Analytics 4 统计访客数据",
    "about.title": "关于",
  ...
  en: {
    ...
    "sync.help": "New to Turso? Follow these steps to get a database URL and token",
    "sync.helpSignup": "Sign up / Log in",
    "sync.helpSignupLink": "Open console",
    "sync.helpStep2Title": "Create a database",
    "sync.helpGuide": "Database quickstart",
    "sync.helpStep3Title": "Create a token",
    ...
    "comments.title": "Comment settings",
    ...
    "deploy.projectIdHint": "Pins to an existing project (never creates); leave empty to find by name, create if missing",
    "deploy.start": "Deploy",
    ...
    "publish.step1": "Stores posts and media. Turso's free tier is enough for a personal blog",
    "publish.step1Link": "Database quickstart",
    "publish.step2Label": "Step 2",
    "publish.step2Title": "Deploy to Vercel",
    "publish.step2": "Follow the guide to deploy to Vercel",
    "publish.step2Link": "Open guide",
    "publish.step3Label": "Step 3",
    "publish.step3Title": "Add sync credentials",
    "publish.step3": "In Sync, paste the database URL and token, then save",
    "publish.step4Label": "Step 4",
    "publish.step4Title": "Set up analytics",
    "publish.step4": "In Analytics, optionally configure Vercel Analytics and Google Analytics 4 to count visitors",
    "about.title": "About",
...
function applyLang() {
  ...
  if (popup) {
    for (const item of popup.querySelectorAll(".select-item")) {
      const selected = item.dataset.value === currentPref
